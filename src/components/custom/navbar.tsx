...
export default function Navbar() {
  ...
  // Move the gradient className construction outside JSX for clarity
  const gradientClassName = `absolute -inset-2 bg-gradient-radial from-transparent ${
    isDarkTheme 
      ? "via-blue-400/30 via-30% via-purple-400/30 via-60% via-red-400/30" 
      : "via-blue-400/20 via-30% via-purple-400/20 via-60% via-red-400/20"
